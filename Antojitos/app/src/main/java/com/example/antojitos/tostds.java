...
public class tostds extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                switch ( selecion ){
                    ...
                    case "SELECCIONA UN GUISADO":
                        ...
                        break;
                    default:
                        Toast.makeText(tostds.this,"error",Toast.LENGTH_LONG).show();
                ...
                if(   vl.isEmpty()  || tipodeguisado == 0){
                    ...
                    Toast.makeText(tostds.this,"faltan campos",Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(tostds.this,"Pedido agregado guisado:" + variable + " cantidad:" + cantidad,Toast.LENGTH_LONG).show();
