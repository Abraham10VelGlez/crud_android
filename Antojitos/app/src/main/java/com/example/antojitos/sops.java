        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch ( selecion ){
                    ...
                    default:
                        Toast.makeText(sops.this,"error",Toast.LENGTH_LONG).show();
                ...
                if(   vl.isEmpty()  || tipodeguisado == 0){
                    ...
                    Toast.makeText(sops.this,"faltan campos",Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(sops.this,"Pedido agregado guisado:" + variable + " cantidad:" + cantidad,Toast.LENGTH_LONG).show();
